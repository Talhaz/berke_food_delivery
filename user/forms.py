...
class SignUpForm(UserCreationForm):
    ...
    address = forms.CharField(max_length=400, label='Address', widget=forms.Textarea(attrs={'class': "txt10 p-l-20","rows":4, "cols":105}))
...
class UserUpdateForm(UserChangeForm):
    class Meta:
        ...
        widgets = {
            ...
            'address': Textarea(attrs={'class': 'bo-rad-10  txt10 p-l-20',"rows":3, "cols":105, 'value': 'address'}),
        }
...
class ProfileUpdateForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'address': Textarea(attrs={'class': ' bo-rad-10  txt10 p-l-20 ',"rows":2, "cols":105, 'placeholder': 'address'}),
